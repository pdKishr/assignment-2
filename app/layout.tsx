...
export default function RootLayout({children} : Readonly<{ children: React.ReactNode}>) {
  ...
  return (
    <html lang="en">
    <body>
        <div className=" flex  p-2  bg-gray-100 w-full h-screen overflow-hidden  ">

            {/* left side fixed bar  */}
            <div className="flex ">

                    {/* tabs section */}
                    <div className="bg-white w-20   flex flex-col gap-0 justify-start items-center rounded-l-lg ">
                          ...
                          <div className="font-extrabold text-3xl flex font-serif border-r-3 pb-6 mt-4 border-gray-100 w-full justify-center items-center">
                            A  <p className="text-green-600 font-extrabold text-3xl">r</p>
                          </div>

                          {/*icons list */}

                          <div className=" w-full h-full flex flex-col gap-0 justify-start items-center rounded-l-lg overflow-y-scroll scroll-hidden">
                                ...
                                <div className="w-20 mb-2 h-full border-r-3 border-gray-100">
                    ...
                    <div className="flex flex-col  bg-white rounded-r-lg p-5 xl:w-100">
                        
                        <div className="my-16">
                          <p className="text-gray-500 font-medium">Welcome to </p>
                          <p className="font-bold text-3xl xl:text-5xl">Arcedia</p>
                        </div> 
                        ...
                        <div className=" overflow-y-scroll scroll-hidden ">
                              ...
                              <div className="flex justify-between">
                                  <p className="font-bold  xl:text-lg ">Message</p>
              ...
              {/* main content */}
            <div className="flex-1 min-h-0 min-w-0 overflow-y-auto scroll-hidden p-3 w-full justify-center items-center">
                    <main>{children}</main> 
